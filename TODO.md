...
- Verify the iNavi settings/menu art after the RGB555 change. If any specific asset still has a green cast, trace whether that bitmap is BI_RGB RGB555, BI_BITFIELDS RGB565, palette-indexed, or host `LoadImageW`/resource-backed before changing conversion globally again.
